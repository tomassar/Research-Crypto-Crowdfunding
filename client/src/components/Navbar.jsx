  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-center lg:items-center md:items-center mb-[35px] gap-6">
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        <div className={`absolute top-[60px] mb-4 right-0 left-0 bg-[#bcbcae] rounded-[5px] z-10 shadow-secondary ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transtition-all duration-700`}>
          <ul className="my-2">
            {navlinks.map((link) => (
              <li
                key={link.name}
